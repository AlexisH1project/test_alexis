	 ...
	 <br>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	            ...
	            <a ><h1><b><?php echo (" $nombreU[0]"); ?></b></h1></a>
	          </li>
	        	</center>
	          <li class=" estilo-color">
	            <a href= <?php  echo ("'./crearUser.php?usuario_rol=$usuarioSeguir'");?> >Crear Usuario</a>
	          </li>
	          <li class=" estilo-color">
	            <a href=  <?php echo ("'./up_supUser.php?usuario_rol=$usuarioSeguir'"); ?> >Actualizar / Eliminar</a>
	          </li>
		    ...
		    <center>
		      ...
		      <div class="collapse navbar-collapse" id="navbarResponsive">
		        ...
		        <ul class="navbar-nav ml-auto">          
		        	...
		        	<h3  class="estilo-colorn">ADMINISTRAR
		          </h3>
