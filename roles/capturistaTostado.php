		...
		<div class="col-sm-12">
				...
				<table class="table table-hover table-white">
					...
					<?php 
						...
						$sql="SELECT id_movimiento_qr, unidad, rfc , curp , fini, tipo_movimiento from fomope_qr WHERE estatus = 'Revisión' AND color_estado = 'negro_2' AND personaAsignada = '$usuarioSeguir'  ORDER BY id_movimiento_qr DESC";
						$result=mysqli_query($conexion,$sql);
			...
			<div class="col-sm-12">
					...
					<table class="table table-hover table-white">
						...
						<?php 
							...
							$sql="SELECT id_movimiento,color_estado,unidad, rfc,quincenaAplicada,fechaIngreso, fechaAutorizacion from fomope WHERE (analistaCap = '$usuarioSeguir' AND color_estado = 'amarillo') ORDER BY id_movimiento DESC";
							$result=mysqli_query($conexion,$sql);
			...
			<div class="col-sm-12">
					...
					<table class="table table-hover table-white">
						...
						<?php 
							...
							$sql="SELECT id_movimiento,color_estado,unidad, rfc,quincenaAplicada,fechaIngreso, fechaAutorizacion
									from fomope WHERE color_estado = 'negro1' ORDER BY id_movimiento DESC";
							$result=mysqli_query($conexion,$sql);
			...
			<div class="col-sm-12">
					...
					<table class="table table-hover table-white">
						...
						<?php 
							...
							$sql="SELECT id_movimiento,color_estado,unidad, rfc,quincenaAplicada,fechaIngreso, fechaAutorizacion
									from fomope WHERE color_estado = 'rosa' ORDER BY id_movimiento DESC";
							$result=mysqli_query($conexion,$sql);
											    ...
											    <div class="modal-content">
											      ...
											      <div class="modal-footer">
											        <button type="button" class="btn btn-secondary" data-dismiss="modal">NO, Regresar</button>
											       	<input type="button" id="autorizarNsi" value="SI" class="btn btn-outline-secondary" onclick="enviarAutorizacion()">
											      </div>
											    </div>
											  </div>
											</div>
